...
public class DBService {
    ...
    public void instanciaDB(){
        ...
        Tecnico tec1 = new Tecnico(null, "Thiago Ferreira", "92336124068", "thiago@mail.com", "123");
        tec1.addPerfil(Perfil.ADMIN);

        Cliente cli1 = new Cliente(null, "Zezinho Torvalds", "37968278104", "torvalds@mail.com", "123");
